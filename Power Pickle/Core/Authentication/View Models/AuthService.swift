...
class AuthService {
    ...
    func createUser(email: String, password: String, fullname: String, username: String) async throws {
        do {
            ...
            await self.uploadUserData(uid: result.user.uid, username: username, fullname: fullname, email: email)
    ...
    private func uploadUserData(uid: String, username: String, fullname: String, email: String) async {
